# =============================================================================
# Landing Zone Workload Pattern - Portal Customer Prod
# This places the portal customer prod subscription into the acme-portals management group
...
module "landing_zone" {
  ...
  # Naming and Tagging
  landing_zone_name = "portals-customer-prod"
  purpose           = "Landing Zone - Portal Customer Prod"
  environment       = var.environment
  location          = var.location
  naming_suffix     = ["portals", "customer", var.environment]
  ...
  ipam_key         = "portals-customer-prod"
