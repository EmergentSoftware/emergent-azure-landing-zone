# =============================================================================
# Landing Zone Workload Pattern - Portal Customer Dev
# This places the portal customer dev subscription into the acme-portals management group
...
module "landing_zone" {
  ...
  # Naming and Tagging
  landing_zone_name = "portals-customer-dev"
  purpose           = "Landing Zone - Portal Customer Dev"
