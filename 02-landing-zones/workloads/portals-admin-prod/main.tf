# =============================================================================
# Landing Zone Subscription Placement - Portal Admin Prod
...
locals {
  common_tags = merge(
    ...
    var.common_tags,
    {
      ...
      LandingZone     = "portals-admin-prod"
...
resource "azurerm_management_group_subscription_association" "portal_prod" {
...
# Log Analytics Workspace for portal prod diagnostics
